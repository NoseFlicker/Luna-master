...
public enum CompilerUtils {
    ...
    /**
     * Add a directory to the class path for compiling. This can be required with custom libraries.
     *
     * @param dir to add.
    ...
    private static byte[] readBytes(File file) {
        ...
        try {
            ...
            close(dis);
            LOGGER.warning("UNABLE TO FUCKING READ");
    ...
    public static void writeText(File file, String text) {
        writeBytes(file, encodeUTF8(text));
    }
    ...
    public static boolean writeBytes(File file, byte[] bytes) {
        ...
        try {
            ...
            close(fos);
            LOGGER.info("FAILED TO DO SO0METHING");
            file.delete();
            if (bak != null) bak.renameTo(file);
