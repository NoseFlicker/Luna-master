...
public class CloudRenderer {
    ...
    public void prepareToRender(boolean renderFancy, int cloudTickCounter, float partialTicks) {
        if (this.renderFancy != renderFancy) this.updated = false;
    ...
    public boolean shouldUpdateGlList() {
        ...
        else if (this.cloudTickCounter >= this.cloudTickCounterUpdate + 20) return true;
        else {
    ...
    public void renderGlList() {
        ...
        if (this.renderFancy) GlStateManager.translate(-cdx / 12.0F, -cdy, -cdz / 12.0F);
        else GlStateManager.translate(-cdx, -cdy, -cdz);
