...
public class Timer {
    ...
    private long lastSyncSysClockModifiedA, lastSyncSysClockModifiedB;
    ...
    /***
     * Change the lastSyncSysClock's value. use *.allowSyncModify(true); before or else it won't have any effect.
     */
    public void setLastSync(long a, long b) {
        lastSyncSysClockModifiedA = allowModify ? a : 0;
        lastSyncSysClockModifiedB = allowModify ? b : 0;
        if (!allowModify)
            System.err.println("Can't modify the lastSyncSysClock speed because it's locked. use allowSyncModify(true); to unlock it.");
    }

    /***
     * Allow and disallow modifications of the lastSyncSysClock variable.
     */
    public void allowSyncModify(boolean allowance) {
        if (!allowance) lastSyncSysClockModifiedA = lastSyncSysClockModifiedB = 0;
        allowModify = allowance;
    }
    ...
    public void updateTimer() {
        ...
        this.lastSyncSysClock = (long) (var1 - MathUtils.setRandom(lastSyncSysClockModifiedA, lastSyncSysClockModifiedB));
