...
import static space.coffos.lija.impl.elements.luna.render.hud.HUD.hotBar;
import static space.coffos.lija.impl.elements.luna.render.hud.HUD.theme;
...
public class GuiIngame extends Gui {
    ...
    public void func_175180_a(float p_175180_1_) {
        ...
        int should = new ScaledResolution(this.mc, this.mc.displayWidth, this.mc.displayHeight).getScaledWidth() / 2
                - 80 + mc.thePlayer.inventory.currentItem * 20;
        int distance = Math.abs(should - animatedWidth) / 12;
        int n = step = Math.max(distance, 3);
        if (animatedWidth < should) {
            animatedWidth = should - animatedWidth >= step ? (animatedWidth += step) : should;
        } else if (animatedWidth > should) {
            animatedWidth = animatedWidth - should >= step ? (animatedWidth -= step) : should;
        }
        ...
        if (Config.isVignetteEnabled()) {
            this.func_180480_a(mc.thePlayer.getBrightness(p_175180_1_), var2);
        } else {
        ...
        if (!mc.thePlayer.isPotionActive(Potion.confusion)) {
            var7 = mc.thePlayer.prevTimeInPortal + (mc.thePlayer.timeInPortal - mc.thePlayer.prevTimeInPortal) * p_175180_1_;
        ...
        if (mc.thePlayer.getSleepTimer() > 0) {
            ...
            var11 = mc.thePlayer.getSleepTimer();
        ...
        if (this.mc.gameSettings.heldItemTooltips && !mc.playerController.enableEverythingIsScrewedUpMode()) {
        ...
        if (this.mc.gameSettings.keyBindPlayerList.getIsKeyPressed() && (!this.mc.isIntegratedServerRunning() || mc.thePlayer.sendQueue.func_175106_d().size() > 1 || var161 != null)) {
        ...
        else NotificationUtil.notifications.clear();
    ...
    protected void func_180479_a(ScaledResolution p_180479_1_, float p_180479_2_) {
        ...
        if (this.mc.func_175606_aa() instanceof EntityPlayer) {
            ...
            if (hotBar.getValBoolean()) {
                drawRect(0, PlayerUtils.getScaledRes().getScaledHeight() - 22,
                ...
                drawRect(0, PlayerUtils.getScaledRes().getScaledHeight() - 22,
                        ...
                        theme.getValString().equalsIgnoreCase("Modern") ? -1 : ColorUtils.getColor(ColorUtils.ColorChoices.MAIN));
    ...
    public void func_175176_b(ScaledResolution p_175176_1_, int p_175176_2_) {
        ...
        if (var3 > 0) {
            short var9 = 182;
            int var10 = (int) (mc.thePlayer.experience * (float) (var9 + 1));
    ...
    public void func_175185_b(ScaledResolution p_175185_1_) {
        ...
        if (mc.theWorld.getTotalWorldTime() >= 120500L) {
            ...
            var2 = I18n.format("demo.remainingTime", StringUtils.ticksToElapsedTime((int) (120500L - mc.theWorld.getTotalWorldTime())));
        }
    ...
    protected boolean func_175183_b() {
        if (this.mc.gameSettings.showDebugInfo && !mc.thePlayer.func_175140_cp() && !this.mc.gameSettings.field_178879_v) {
            return false;
        } else if (mc.playerController.enableEverythingIsScrewedUpMode()) {
            if (this.mc.pointedEntity != null) {
                ...
                if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                    ...
                    return mc.theWorld.getTileEntity(var1) instanceof IInventory;
                }
    ...
    private void func_175184_a(int p_175184_1_, int p_175184_2_, int p_175184_3_, float p_175184_4_, EntityPlayer p_175184_5_) {
        ...
        if (var6 != null) {
            ...
            this.itemRenderer.func_175030_a(mc.fontRendererObj, var6, p_175184_2_, p_175184_3_);
        }
    }
