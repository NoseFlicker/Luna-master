...
import space.coffos.lija.impl.elements.luna.render.Chams;
import space.coffos.lija.impl.elements.luna.render.ESP;
...
public abstract class RendererLivingEntity extends Render {
    ...
    public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_))) {
            if ((LiJA.INSTANCE.elementManager.getElement(Chams.class).isToggled()) && (Chams.isCorrect(p_76986_1_))) {
                GL11.glEnable(32823);
            ...
            if (Reflector.ForgeEntity_shouldRiderSit.exists()) {
                this.mainModel.isRiding = p_76986_1_.isRiding() && p_76986_1_.ridingEntity != null && Reflector.callBoolean(p_76986_1_.ridingEntity, Reflector.ForgeEntity_shouldRiderSit);
            }
            ...
            if (!Reflector.RenderLivingEvent_Post_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Post_Constructor, p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_))) {
            }
        }
    }
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        ...
        if (var8 || var9) {
            ...
            if (LiJA.INSTANCE.elementManager.getElement(ESP.class).isToggled() & ESP.mode.getValString().equalsIgnoreCase("Fill") & p_77036_1_ != mc.thePlayer & p_77036_1_ instanceof EntityPlayer & RenderUtils.isInFrustumView(p_77036_1_)) {
                int rgb = ESP.colorType.getValString().equalsIgnoreCase("Custom") ? new Color((int) ESP.fillColorR.getValDouble(), (int) ESP.fillColorG.getValDouble(), (int) ESP.fillColorB.getValDouble()).getRGB() : RenderUtils.getRainbow(6000, 16).getRGB();
                if (FriendManager.isFriend(p_77036_1_.getName())) rgb = new Color(0, 192, 255).getRGB();
    ...
    public void passSpecialRender(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_, double p_77033_6_) {
        LiJA.INSTANCE.eventManager.register(new EventRenderNameTag(p_77033_1_));
        if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, p_77033_1_, this, Double.valueOf(p_77033_2_), Double.valueOf(p_77033_4_), Double.valueOf(p_77033_6_))) {
            ...
            if (!Reflector.RenderLivingEvent_Specials_Post_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Post_Constructor, p_77033_1_, this, Double.valueOf(p_77033_2_), Double.valueOf(p_77033_4_), Double.valueOf(p_77033_6_))) {
            }
        }
    }
