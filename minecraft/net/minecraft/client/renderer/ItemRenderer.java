...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float p_78440_1_) {
        ...
        boolean var420 = var3.getCurrentEquippedItem() != null && !(var3.getCurrentEquippedItem().getItem() instanceof ItemBlock) && LiJA.INSTANCE.elementManager.getElement(Scaffold.class).isToggled();
        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() == Items.filled_map) {
            ...
            } else if (var3.getItemInUseCount() > 0 || LiJA.INSTANCE.elementManager.getElement(KillAura.class).isToggled() && KillAura.autoBlock.getValBoolean() && KillAura.block) {
                ...
                switch (ItemRenderer.SwitchEnumAction.field_178094_a[var7.ordinal()]) {
                    ...
                    case 4:
                        ...
                        func_178096_b(0, var2);
                        func_178103_d();
                        GlStateManager.translate(-0.07F, 0.35F, 0.35F);
                        GlStateManager.rotate(-var15 * 20.0F, -5.0F, -5.0F, 9.0F);

//                        func_178096_b(var2, var4);
//                        GL11.glTranslated(0.9D, 0.0D, 0.5D);
//                        float var15 = MathHelper.sin(MathHelper.sqrt_float(var4) * 3.1415927F);
//                        GlStateManager.rotate(-var15 * -80.0f, 1.0f, 0.0f, 1.0f);
//                        func_178103_d();
                        break;
                    case 5:
                        this.func_178096_b(var2, var4);
