...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer {
    ...
    public void func_180538_a(TileEntityChest p_180538_1_, double p_180538_2_, double p_180538_4_, double p_180538_6_, float p_180538_8_, int p_180538_9_) {
        ...
        if (p_180538_1_.adjacentChestZNeg == null && p_180538_1_.adjacentChestXNeg == null) {
            ...
            var15.chestLid.rotateAngleX = -(var13 * (float) Math.PI / 3.3F);//Chest open gap
            boolean doOutline = ESP.chests.getValBoolean() && LiJA.INSTANCE.elementManager.getElement(ESP.class).isToggled();
            ...
            if (doOutline && p_180538_1_.hasWorldObj()) {
                ...
                if (HUD.theme.getValString().equalsIgnoreCase("Ejaculation")) {
                    RenderUtils.renderFour(RenderUtils.getRainbow(1500, 1).getRGB());
                } else {
                    RenderUtils.renderFour(new Color(75, 0, 130).getRGB());
                }
                var15.renderAll();
