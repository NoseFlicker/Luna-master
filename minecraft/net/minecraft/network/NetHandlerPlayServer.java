...
public class NetHandlerPlayServer implements INetHandlerPlayServer, IUpdatePlayerListBox {
    ...
    public void kickPlayerFromServer(String reason) {
        ...
        this.netManager.sendPacket(new S40PacketDisconnect(var2), p_operationComplete_1_ -> NetHandlerPlayServer.this.netManager.closeChannel(var2));
        ...
        if (!this.playerEntity.playerConqueredTheEnd) {
            ...
            if (this.hasMoved) {
                ...
                if (this.playerEntity.ridingEntity != null) {
                    ...
                    if (this.playerEntity.ridingEntity != null) this.playerEntity.ridingEntity.updateRiderPosition();
                ...
                if (this.playerEntity.onGround && !packetIn.func_149465_i() && var29 > 0.0D) this.playerEntity.jump();
                ...
                if (var29 > -0.5D || var29 < 0.5D) var29 = 0.0D;
    ...
    public void func_175089_a(double p_175089_1_, double p_175089_3_, double p_175089_5_, float p_175089_7_, float p_175089_8_, Set p_175089_9_) {
        ...
        if (p_175089_9_.contains(S08PacketPlayerPosLook.EnumFlags.X)) this.lastPosX += this.playerEntity.posX;
        if (p_175089_9_.contains(S08PacketPlayerPosLook.EnumFlags.Y)) this.lastPosY += this.playerEntity.posY;
        if (p_175089_9_.contains(S08PacketPlayerPosLook.EnumFlags.Z)) this.lastPosZ += this.playerEntity.posZ;
    ...
    public void processPlayerDigging(C07PacketPlayerDigging packetIn) {
        ...
        switch (NetHandlerPlayServer.SwitchAction.field_180224_a[packetIn.func_180762_c().ordinal()]) {
            case 1:
                if (!this.playerEntity.func_175149_v()) this.playerEntity.dropOneItem(false);
                return;

            case 2:
                if (!this.playerEntity.func_175149_v()) this.playerEntity.dropOneItem(true);
                return;
            ...
            case 6:
                ...
                if (var10 > 36.0D) return;
                else if (var3.getY() >= this.serverController.getBuildLimit()) return;
                else {
    ...
    public void processPlayerBlockPlacement(C08PacketPlayerBlockPlacement packetIn) {
        ...
        if (packetIn.getPlacedBlockDirection() == 255) {
            ...
            ChatComponentTranslation var7 = new ChatComponentTranslation("build.tooHigh", Integer.valueOf(this.serverController.getBuildLimit()));
