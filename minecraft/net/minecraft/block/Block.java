...
public class Block {
    ...
    public MovingObjectPosition collisionRayTrace(World worldIn, BlockPos pos, Vec3 start, Vec3 end) {
        ...
        if (!this.isVecInsideYZBounds(var5)) var5 = null;
        if (!this.isVecInsideYZBounds(var6)) var6 = null;
        if (!this.isVecInsideXZBounds(var7)) var7 = null;
        if (!this.isVecInsideXZBounds(var8)) var8 = null;
        if (!this.isVecInsideXYBounds(var9)) var9 = null;
        if (!this.isVecInsideXYBounds(var10)) var10 = null;
        Vec3 var11 = null;
        if (var5 != null) {
            if (var11 != null) {
    ...
    public static boolean isEqualTo(Block blockIn, Block other) {
        return (blockIn != null && other != null) && (blockIn == other ? true : blockIn.isAssociatedBlock(other));
    }
    ...
    public enum EnumOffsetType {
        ...
        EnumOffsetType(String p_i45733_1_, int p_i45733_2_) {
        }
    }
