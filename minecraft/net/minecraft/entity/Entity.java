...
import space.coffos.lija.impl.elements.luna.movement.WebMove;
...
import space.coffos.lija.impl.events.EventStep;
import space.coffos.lija.impl.managers.ElementManager;
...
public abstract class Entity extends ArrayList<Entity> implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            if (this.isInWeb) {
                this.isInWeb = false;
                x *= LiJA.INSTANCE.elementManager.getElement(WebMove.class).isToggled() ? WebMove.speed.getValDouble() : 0.25D;
                y *= 0.05000000074505806D;
                z *= LiJA.INSTANCE.elementManager.getElement(WebMove.class).isToggled() ? WebMove.speed.getValDouble() : 0.25D;
                this.motionX = 0.0D;
                this.motionY = 0.0D;
                this.motionZ = 0.0D;
            }
            ...
            double var15 = y;
            double var17 = z;
            boolean var19 = this.onGround && this.isSneaking() && this instanceof EntityPlayer || LiJA.INSTANCE.elementManager.getElement(Scaffold.class).isToggled() && BlockUtils.getBlockUnderPlayer(mc.thePlayer, 1) instanceof BlockAir;
            ...
            this.onGround = LiJA.INSTANCE.elementManager.getElement(Flight.class).isToggled() & Flight.mode.getValString().equalsIgnoreCase("Hypixel") | ((this.isCollidedVertically) && (var15 < 0.0D));
    ...
    /**
     * Return the Entity structure making up this Entity (currently only for dragons)
     */
    ...
    public String toString() {
        return String.format("%s[\'%s\'/%d, loader=\'%s\', x=%.2f, y=%.2f, z=%.2f]", new Object[]{this.getClass().getSimpleName(), this.getName(), Integer.valueOf(this.entityId), this.worldObj == null ? "~NULL~" : this.worldObj.getWorldInfo().getWorldName(), Double.valueOf(this.posX), Double.valueOf(this.posY), Double.valueOf(this.posZ)});
    }
     ...
     */
    public float getExplosionResistance(Explosion p_180428_1_, World worldIn, BlockPos p_180428_3_, IBlockState
            p_180428_4_) {
        return p_180428_4_.getBlock().getExplosionResistance(this);
    }

    public boolean func_174816_a(Explosion p_174816_1_, World worldIn, BlockPos p_174816_3_, IBlockState
